...
@Component({
  selector: 'vex-screening-status',
  templateUrl: './screening-status.component.html',
  styleUrls: ['./screening-status.component.scss'],
    animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class ScreeningstatusComponent implements OnInit {
